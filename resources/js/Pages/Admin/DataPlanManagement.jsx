...
export default function DataPlanManagement() {
    ...
    return (
        <>
            <Head title="Data Plan Management" />
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex justify-between items-center py-6">
                            <div className="flex items-center">
                                ...
                                <div>
                                    <h1 className="text-2xl font-bold text-gray-900">Data Plan Management</h1>
                                    <p className="text-sm text-gray-500">Manage data plans for multi-registrations</p>
                                </div>
                            </div>
